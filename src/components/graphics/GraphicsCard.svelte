<script lang="ts">
  ...
  import type { GraphicsTopicCardData, GraphicsTopicLink } from '@/lib/graphics';

  export let topic: GraphicsTopicCardData;

  function preview(items: GraphicsTopicLink[], limit = 3): GraphicsTopicLink[] {
    return items.slice(0, limit);
  }
</script>

<a href={`/graphics/${topic.slug}`} class="block h-full">
